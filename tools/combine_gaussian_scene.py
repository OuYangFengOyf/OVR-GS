...
def combine_gaussian(dataset : ModelParams, iteration : int, pipeline : PipelineParams, object_list):
    """ 
    ...
    for object_id in object_list:
        ...
        obj_model_path = f'_object_removal/iteration_2000/point_cloud_{object_id}.ply'
...
if __name__ == "__main__":
    ...
    combine_gaussian(model.extract(args), args.iteration, pipeline.extract(args), args.object_list)

    # python tools/combine_gaussian_scene.py -s data/TF-OVOR/fruits -m output/TF-OVOR/fruits
