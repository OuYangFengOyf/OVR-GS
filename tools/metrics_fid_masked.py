...
def evaluate(model_paths, crop_ratio=1.0, resize=1.0):
    ...
    for scene_dir in model_paths:
        ...
        for test_dir in waiting_eval_list:
            ...
            mask_dir = Path("data") / "TF-OVOR" / dataset_name / "unseen_mask"
    ...
    mean_result_path = "output/TF-OVOR/all_scene_evaluation_results.json"
    with open(mean_result_path, "w") as f:
        json.dump(all_results, f, indent=2)

    print(f"âœ?Saved full results to {mean_result_path}")
